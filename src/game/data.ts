...
export const RELIC_LEVEL_EXP = [0, 100, 250, 450, 700, 1000, 1400, 1900, 2500, 3200, 4000];
export const RELIC_MAX_LEVEL = 10;
export const RELIC_LEVEL_STAT_MULTIPLIER = 0.1;

export const RELIC_DROP_CONFIG: Record<string, { dropChanceMultiplier: number; shardDropChance: number; minShards: number; maxShards: number }> = {
  normal: { dropChanceMultiplier: 0.3, shardDropChance: 0.1, minShards: 1, maxShards: 2 },
  elite: { dropChanceMultiplier: 1.0, shardDropChance: 0.35, minShards: 2, maxShards: 5 },
  boss: { dropChanceMultiplier: 2.5, shardDropChance: 0.7, minShards: 5, maxShards: 15 },
};

export const RELIC_COMPAT_BONUS = 0.25;

export const RELICS: Relic[] = [
  {
    id: 'forest_blade',
    name: '翠叶之刃',
    description: '由千年古树精华凝聚而成的利刃，蕴含森林的守护之力。',
    lore: '传说中精灵族的创世神器，只有获得森林认可的勇者方可 wield。',
    icon: '🗡️',
    rarity: 'rare',
    element: 'wind',
    category: 'weapon',
    baseStats: [
      { stat: 'attack', value: 15, isPercent: false },
      { stat: 'speed', value: 3, isPercent: false },
    ],
    awakenedStats: [
      { stat: 'attack', value: 30, isPercent: false },
      { stat: 'speed', value: 8, isPercent: false },
      { stat: 'critRate', value: 0.05, isPercent: true },
    ],
    compatibleCompanionIds: ['forest_archer', 'forest_ranger'],
    compatibleClasses: ['弓箭手', '盗贼'],
    compatibleRaces: ['精灵'],
    dropAreas: ['forest'],
    dropMonsterTiers: ['elite', 'boss'],
    dropChance: 0.08,
    requiredPlayerLevel: 5,
    awakenCost: { shards: 30, soulOrbs: 5 },
  },
  {
    id: 'cave_guardian_shield',
    name: '岩心之盾',
    description: '以洞穴最深处的岩心锻造而成，坚不可摧。',
    lore: '矮人族守护千年的圣物，据说能挡住恶龙的吐息。',
    icon: '🛡️',
    rarity: 'rare',
    element: 'earth',
    category: 'armor',
    baseStats: [
      { stat: 'defense', value: 12, isPercent: false },
      { stat: 'hp', value: 50, isPercent: false },
    ],
    awakenedStats: [
      { stat: 'defense', value: 25, isPercent: false },
      { stat: 'hp', value: 150, isPercent: false },
      { stat: 'defense', value: 0.05, isPercent: true },
    ],
    compatibleCompanionIds: ['dwarf_blacksmith', 'cave_explorer'],
    compatibleClasses: ['战士', '骑士', '牧师'],
    compatibleRaces: ['矮人', '人类'],
    dropAreas: ['cave'],
    dropMonsterTiers: ['elite', 'boss'],
    dropChance: 0.08,
  ...
  },
  {
    id: 'ancient_rune_stone',
    name: '太古符文石',
    description: '刻有远古文明符文的神秘石板，蕴含无尽的奥术能量。',
    lore: '太古文明的遗产，每一个符文都代表着一条宇宙法则。',
    icon: '📜',
    rarity: 'epic',
    element: 'light',
    category: 'rune',
    baseStats: [
      { stat: 'attack', value: 20, isPercent: false },
      { stat: 'mp', value: 30, isPercent: false },
      { stat: 'expBonus', value: 0.05, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'attack', value: 45, isPercent: false },
      { stat: 'mp', value: 80, isPercent: false },
      { stat: 'expBonus', value: 0.15, isPercent: true },
      { stat: 'critDamage', value: 0.1, isPercent: true },
    ],
    compatibleCompanionIds: ['ruins_scholar', 'dark_mage', 'holy_priest'],
    compatibleClasses: ['法师', '牧师'],
    compatibleRaces: ['人类', '魔族'],
    dropAreas: ['ruins'],
    dropMonsterTiers: ['elite', 'boss'],
    dropChance: 0.05,
    requiredPlayerLevel: 28,
    awakenCost: { shards: 50, soulOrbs: 10 },
  },
  {
    id: 'flame_heart_pendant',
    name: '烈焰之心吊坠',
    description: '蕴含着火山核心能量的吊坠，佩戴者能感受到远古火龙的心跳。',
    lore: '据说这条吊坠是用第一条火龙的心脏结晶打造的。',
    icon: '🔥',
    rarity: 'epic',
    element: 'fire',
    category: 'accessory',
    baseStats: [
      { stat: 'attack', value: 25, isPercent: false },
      { stat: 'critRate', value: 0.03, isPercent: true },
      { stat: 'goldBonus', value: 0.05, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'attack', value: 55, isPercent: false },
      { stat: 'critRate', value: 0.08, isPercent: true },
      { stat: 'critDamage', value: 0.15, isPercent: true },
      { stat: 'goldBonus', value: 0.15, isPercent: true },
    ],
    compatibleCompanionIds: ['volcano_warrior', 'dragon_knight'],
    compatibleClasses: ['战士', '法师', '骑士'],
    compatibleRaces: ['龙族', '兽人', '魔族'],
    dropAreas: ['volcano'],
    dropMonsterTiers: ['elite', 'boss'],
    dropChance: 0.05,
    requiredPlayerLevel: 52,
    awakenCost: { shards: 50, soulOrbs: 10 },
  },
  {
    id: 'soul_reaper_scythe',
    name: '噬魂镰',
    description: '来自深渊的暗黑神器，能够收割敌人的灵魂增强自身。',
    lore: '传闻死神曾使用这把镰刀收割了无数英雄的灵魂。',
    icon: '🪓',
    rarity: 'legendary',
    element: 'dark',
    category: 'weapon',
    baseStats: [
      { stat: 'attack', value: 50, isPercent: false },
      { stat: 'critRate', value: 0.05, isPercent: true },
      { stat: 'critDamage', value: 0.1, isPercent: true },
      { stat: 'soulOrbBonus', value: 0.1, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'attack', value: 100, isPercent: false },
      { stat: 'critRate', value: 0.12, isPercent: true },
      { stat: 'critDamage', value: 0.25, isPercent: true },
      { stat: 'soulOrbBonus', value: 0.25, isPercent: true },
      { stat: 'attack', value: 0.1, isPercent: true },
    ],
    compatibleCompanionIds: ['dark_mage', 'volcano_warrior'],
    compatibleClasses: ['盗贼', '法师', '战士'],
    compatibleRaces: ['魔族', '兽人'],
    dropAreas: ['ruins', 'volcano'],
    dropMonsterTiers: ['boss'],
    dropChance: 0.02,
    requiredPlayerLevel: 40,
    awakenCost: { shards: 80, soulOrbs: 20 },
  },
  {
    id: 'holy_light_crown',
    name: '圣光王冠',
    description: '神圣之力凝聚而成的王冠，只有真正的圣者才配佩戴。',
    lore: '光明神降临大陆时遗落的神器，蕴含着无穷的祝福之力。',
    icon: '👑',
    rarity: 'legendary',
    element: 'light',
    category: 'treasure',
    baseStats: [
      { stat: 'defense', value: 35, isPercent: false },
      { stat: 'hp', value: 200, isPercent: false },
      { stat: 'mp', value: 50, isPercent: false },
      { stat: 'expBonus', value: 0.08, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'defense', value: 75, isPercent: false },
      { stat: 'hp', value: 500, isPercent: false },
      { stat: 'mp', value: 120, isPercent: false },
      { stat: 'expBonus', value: 0.2, isPercent: true },
      { stat: 'hp', value: 0.1, isPercent: true },
    ],
    compatibleCompanionIds: ['holy_priest', 'dragon_knight'],
    compatibleClasses: ['牧师', '骑士'],
    compatibleRaces: ['人类', '精灵', '龙族'],
    dropAreas: ['ruins', 'volcano'],
    dropMonsterTiers: ['boss'],
    dropChance: 0.02,
  ...
  },
  {
    id: 'dragon_soul_orb',
    name: '龙魂宝珠',
    description: '封印着远古龙魂的神秘宝珠，共鸣时能释放毁天灭地之力。',
    lore: '龙神陨落时，其灵魂凝结成这颗宝珠，等待着真正的龙裔觉醒。',
    icon: '🐉',
    rarity: 'mythic',
    element: 'fire',
    category: 'treasure',
    baseStats: [
      ...
      { stat: 'defense', value: 40, isPercent: false },
      { stat: 'hp', value: 300, isPercent: false },
      { stat: 'critRate', value: 0.08, isPercent: true },
      { stat: 'critDamage', value: 0.2, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'attack', value: 160, isPercent: false },
      { stat: 'defense', value: 90, isPercent: false },
      { stat: 'hp', value: 700, isPercent: false },
      { stat: 'critRate', value: 0.15, isPercent: true },
      { stat: 'critDamage', value: 0.4, isPercent: true },
      { stat: 'attack', value: 0.15, isPercent: true },
      { stat: 'hp', value: 0.15, isPercent: true },
    ],
    compatibleCompanionIds: ['dragon_knight', 'volcano_warrior'],
    compatibleClasses: ['骑士', '战士', '法师'],
    compatibleRaces: ['龙族'],
    dropAreas: ['volcano'],
    dropMonsterTiers: ['boss'],
    dropChance: 0.008,
    requiredPlayerLevel: 60,
    awakenCost: { shards: 150, soulOrbs: 50 },
  },
  {
    id: 'wind_walker_boots',
    name: '风行靴',
    description: '蕴含风之精灵祝福的靴子，穿上它仿佛能御风而行。',
    lore: '风神赐予最虔诚的信徒的圣物，传说穿上它能追上疾风。',
    icon: '👟',
    rarity: 'rare',
    element: 'wind',
    category: 'accessory',
    baseStats: [
      { stat: 'speed', value: 8, isPercent: false },
      { stat: 'dodge', value: 0.03, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'speed', value: 18, isPercent: false },
      { stat: 'dodge', value: 0.08, isPercent: true },
      { stat: 'speed', value: 0.05, isPercent: true },
    ],
    compatibleCompanionIds: ['forest_ranger', 'cave_explorer'],
    compatibleClasses: ['盗贼', '弓箭手'],
    compatibleRaces: ['精灵', '人类', '矮人'],
    dropAreas: ['forest', 'cave'],
    dropMonsterTiers: ['elite', 'boss'],
    dropChance: 0.06,
  ...
  {
    id: 'abyssal_water_ring',
    name: '深渊之水戒指',
    description: '由深海最纯净的水元素凝结而成，蕴含着治愈的力量。',
    lore: '水之女神的眼泪化作的戒指，能净化一切伤痛。',
    icon: '💍',
    rarity: 'epic',
    element: 'water',
    category: 'accessory',
    baseStats: [
      { stat: 'hp', value: 100, isPercent: false },
      { stat: 'mp', value: 40, isPercent: false },
      { stat: 'defense', value: 10, isPercent: false },
    ],
    awakenedStats: [
      { stat: 'hp', value: 280, isPercent: false },
      { stat: 'mp', value: 100, isPercent: false },
      { stat: 'defense', value: 25, isPercent: false },
      { stat: 'hp', value: 0.08, isPercent: true },
    ],
    compatibleCompanionIds: ['holy_priest', 'forest_archer'],
    compatibleClasses: ['牧师', '法师', '弓箭手'],
    compatibleRaces: ['精灵', '人类'],
    dropAreas: ['cave', 'ruins'],
    dropMonsterTiers: ['elite', 'boss'],
    dropChance: 0.04,
  ...
  },
  {
    id: 'lucky_coin',
    name: '幸运金币',
    description: '被幸运女神亲吻过的金币，持有者财运亨通。',
    lore: '据说这枚金币能吸引财富，让持有者永远不会缺钱花。',
    icon: '🪙',
    rarity: 'rare',
    element: 'light',
    category: 'treasure',
    baseStats: [
      { stat: 'luck', value: 5, isPercent: false },
      { stat: 'goldBonus', value: 0.1, isPercent: true },
    ],
    awakenedStats: [
      { stat: 'luck', value: 12, isPercent: false },
      { stat: 'goldBonus', value: 0.25, isPercent: true },
      { stat: 'soulOrbBonus', value: 0.1, isPercent: true },
    ],
    compatibleCompanionIds: ['cave_explorer', 'forest_ranger', 'ruins_scholar'],
    compatibleClasses: ['盗贼', '商人'],
    compatibleRaces: ['人类', '矮人', '精灵'],
    dropAreas: ['forest', 'cave', 'ruins', 'volcano'],
    dropMonsterTiers: ['normal', 'elite', 'boss'],
    dropChance: 0.1,
    requiredPlayerLevel: 1,
    awakenCost: { shards: 30, soulOrbs: 5 },
  },
  {
    id: 'novice_iron_sword',
    name: '新手铁剑',
    description: '每一位冒险者踏入冒险的起点，虽然普通却蕴含无限可能。',
    lore: '铁匠铺里最常见的铁剑，但真正的英雄就是从这里起步的。',
    icon: '🔪',
    rarity: 'common',
    element: 'earth',
    category: 'weapon',
    baseStats: [
      { stat: 'attack', value: 5, isPercent: false },
    ],
    awakenedStats: [
      { stat: 'attack', value: 12, isPercent: false },
      { stat: 'expBonus', value: 0.03, isPercent: true },
    ],
    compatibleCompanionIds: ['novice_warrior'],
    compatibleClasses: ['战士', '骑士', '盗贼'],
    compatibleRaces: ['人类', '矮人', '兽人'],
    dropAreas: ['forest'],
    dropMonsterTiers: ['normal', 'elite'],
    dropChance: 0.15,
    requiredPlayerLevel: 1,
    awakenCost: { shards: 20, soulOrbs: 3 },
  },
  {
    id: 'mage_crystal_staff',
    name: '法师水晶杖',
    description: '镶嵌着魔力水晶的法杖，能增幅施法者的奥术能量。',
    lore: '每一位法师学徒梦寐以求的法杖，是成为大法师的第一步。',
    icon: '🪄',
    rarity: 'common',
    element: 'water',
    category: 'weapon',
    baseStats: [
      { stat: 'attack', value: 4, isPercent: false },
      { stat: 'mp', value: 15, isPercent: false },
    ],
    awakenedStats: [
      { stat: 'attack', value: 10, isPercent: false },
      { stat: 'mp', value: 40, isPercent: false },
      { stat: 'expBonus', value: 0.03, isPercent: true },
    ],
    compatibleCompanionIds: ['ruins_scholar'],
    compatibleClasses: ['法师', '牧师'],
    compatibleRaces: ['人类', '精灵', '魔族'],
    dropAreas: ['forest', 'cave'],
    dropMonsterTiers: ['normal', 'elite'],
    dropChance: 0.12,
...
export const RELIC_SETS: RelicSet[] = [
  {
    ...
    name: '森林守护者',
    description: '来自古老森林的守护之力，唤醒自然之神的庇护。',
    icon: '🌲',
    relicIds: ['forest_blade', 'wind_walker_boots'],
    setBonuses: [
      { count: 2, effects: [
        { stat: 'attack', value: 15, isPercent: false },
  ...
  {
    id: 'mountain_fortress_set',
    name: '山岳堡垒',
    description: '大地之力凝聚而成的绝对防御，如山岳般不可动摇。',
    icon: '⛰️',
    relicIds: ['cave_guardian_shield', 'abyssal_water_ring'],
    setBonuses: [
      { count: 2, effects: [
        { stat: 'defense', value: 20, isPercent: false },
        { stat: 'hp', value: 200, isPercent: false },
        { stat: 'defense', value: 0.05, isPercent: true },
      ]},
    ],
  ...
  {
    id: 'arcane_master_set',
    name: '奥术主宰',
    description: '太古知识与现代魔法的完美融合，掌控奥术的终极力量。',
    icon: '🔮',
    relicIds: ['ancient_rune_stone', 'mage_crystal_staff'],
    setBonuses: [
      { count: 2, effects: [
        { stat: 'attack', value: 30, isPercent: false },
        { stat: 'mp', value: 100, isPercent: false },
        { stat: 'expBonus', value: 0.1, isPercent: true },
      ]},
    ],
  },
  {
    id: 'inferno_conqueror_set',
    name: '炎狱征服者',
    description: '征服烈焰与地狱的力量，化身焚尽一切的火焰魔神。',
    icon: '🌋',
    relicIds: ['flame_heart_pendant', 'soul_reaper_scythe'],
    setBonuses: [
      { count: 2, effects: [
        { stat: 'attack', value: 60, isPercent: false },
        { stat: 'critRate', value: 0.08, isPercent: true },
        { stat: 'critDamage', value: 0.2, isPercent: true },
      ]},
    ],
  ...
  {
    id: 'divine_dragon_set',
    name: '神龙降世',
    description: '传说中的龙神之力，唤醒它的人将获得凌驾一切的力量。',
    icon: '🐲',
    relicIds: ['dragon_soul_orb', 'holy_light_crown'],
    setBonuses: [
      { count: 2, effects: [
        { stat: 'attack', value: 100, isPercent: false },
        { stat: 'defense', value: 50, isPercent: false },
        { stat: 'hp', value: 400, isPercent: false },
        { stat: 'attack', value: 0.1, isPercent: true },
        { stat: 'hp', value: 0.1, isPercent: true },
      ]},
    ],
  },
  {
    id: 'fortune_set',
    name: '天选之人',
    description: '命运女神的祝福降临，好运将永远伴随着你。',
    icon: '🍀',
    relicIds: ['lucky_coin', 'holy_light_crown'],
    setBonuses: [
      { count: 2, effects: [
        { stat: 'luck', value: 15, isPercent: false },
        { stat: 'goldBonus', value: 0.2, isPercent: true },
        { stat: 'soulOrbBonus', value: 0.15, isPercent: true },
        { stat: 'expBonus', value: 0.1, isPercent: true },
      ]},
    ],
  },
...
function generateBuildingLevels(
  baseCost: number,
  ...
  maxLevel: number,
  currency: 'gold' | 'soulOrbs' = 'gold',
  productionCurrency: 'gold' | 'exp' | 'soulOrbs' = 'gold',
  baseSlots: number = 1
) {
  const levels = [];
  for (let i = 1; i <= maxLevel; i++) {
    levels.push({
      level: i,
      upgradeCost: Math.floor(baseCost * Math.pow(costMultiplier, i - 1)),
      upgradeCurrency: currency,
      productionRate: Math.floor(baseProduction * Math.pow(productionMultiplier, i - 1)),
      productionCurrency,
      capacity: Math.floor(baseCapacity * Math.pow(capacityMultiplier, i - 1)),
      stationSlots: baseSlots + Math.floor((i - 1) / 3),
    });
  }
  return levels;
}
...
export const BUILDINGS: Building[] = [
  {
    ...
    type: 'gold_mine',
    name: '金矿',
    description: '开采金矿，持续产出金币',
    icon: '⛏️',
    bgColor: '#fbbf24',
    maxLevel: 20,
    unlockLevel: 5,
    levels: generateBuildingLevels(200, 1.5, 10, 1.3, 500, 1.4, 20, 'gold', 'gold'),
  },
  {
    id: 'lumber_mill',
    type: 'lumber_mill',
    name: '伐木场',
    description: '砍伐木材，出售换取金币',
    icon: '🪓',
    bgColor: '#22c55e',
    maxLevel: 20,
    unlockLevel: 5,
    levels: generateBuildingLevels(180, 1.5, 8, 1.3, 400, 1.4, 20, 'gold', 'gold'),
  },
  {
    id: 'stone_quarry',
    type: 'stone_quarry',
    name: '采石场',
    description: '开采石料，提升防御加成',
    icon: '🪨',
    bgColor: '#6b7280',
    maxLevel: 20,
    unlockLevel: 8,
    levels: generateBuildingLevels(300, 1.5, 5, 1.25, 300, 1.3, 20, 'gold', 'gold'),
  },
  {
    id: 'farm',
    type: 'farm',
    name: '农场',
    description: '种植作物，提供稳定的经验收益',
    icon: '🌾',
    bgColor: '#84cc16',
    maxLevel: 20,
    unlockLevel: 10,
    levels: generateBuildingLevels(500, 1.6, 15, 1.35, 800, 1.4, 20, 'gold', 'exp'),
  },
  {
    id: 'tavern',
    type: 'tavern',
    name: '酒馆',
    description: '招募冒险者，增加商人事件出现概率',
    icon: '🍺',
    bgColor: '#f97316',
    maxLevel: 15,
    unlockLevel: 12,
    levels: generateBuildingLevels(800, 1.7, 0, 1, 0, 1, 15, 'gold', 'gold'),
  },
  {
    id: 'forge',
    type: 'forge',
    name: '锻造坊',
    description: '锻造武器装备，提升攻击加成',
    icon: '🔨',
    bgColor: '#ef4444',
    maxLevel: 20,
    unlockLevel: 15,
    levels: generateBuildingLevels(1000, 1.6, 0, 1, 0, 1, 20, 'gold', 'gold'),
  },
  {
    id: 'warehouse',
    type: 'warehouse',
    name: '仓库',
    description: '增加所有建筑的资源存储上限',
    icon: '🏭',
    bgColor: '#a855f7',
    maxLevel: 15,
    unlockLevel: 10,
    levels: generateBuildingLevels(600, 1.5, 0, 1, 0, 1, 15, 'gold', 'gold'),
  },
  {
    id: 'market',
    type: 'market',
    name: '市场',
    description: '繁华的市场，吸引更多商人来访',
    icon: '🏪',
    bgColor: '#3b82f6',
    maxLevel: 15,
    unlockLevel: 20,
    levels: generateBuildingLevels(1500, 1.6, 12, 1.3, 600, 1.35, 15, 'gold', 'gold'),
  },
  {
    id: 'barracks',
    type: 'barracks',
    name: '兵营',
    description: '训练士兵，提升整体防御',
    icon: '⚔️',
    bgColor: '#dc2626',
    maxLevel: 20,
    unlockLevel: 18,
    levels: generateBuildingLevels(1200, 1.5, 0, 1, 0, 1, 20, 'gold', 'gold'),
  },
  {
    id: 'temple',
    type: 'temple',
    name: '神殿',
    description: '供奉神灵，获得魂珠祝福',
    icon: '⛩️',
    bgColor: '#8b5cf6',
    maxLevel: 10,
    unlockLevel: 30,
    levels: generateBuildingLevels(5, 2, 1, 1.5, 20, 1.3, 10, 'soulOrbs', 'soulOrbs', 2),
  },
];

export const MERCHANT_EVENTS: MerchantEvent[] = [
  {
    id: 'traveling_merchant',
    title: '流浪商人来访',
    description: '一位神秘的流浪商人来到了你的城镇，带来了珍稀物品。',
    merchantName: '流浪商人·马可',
    merchantAvatar: '🧔',
    type: 'buy',
    rarity: 'common',
    icon: '🎒',
    ...
    items: [
      {
        id: 'merchant_exp_potion',
        name: '经验药水',
        description: '立即获得 500 经验值',
        icon: '🧪',
        price: 300,
        priceCurrency: 'gold',
        rewardType: 'exp',
      ...
      {
        id: 'merchant_gold_bag',
        name: '金币袋',
        description: '立即获得 800 金币',
        icon: '💰',
        price: 3,
        priceCurrency: 'soulOrbs',
        rewardType: 'gold',
        rewardValue: 800,
        stock: 3,
        rarity: 'rare',
      ...
      {
        id: 'merchant_attack_scroll',
        name: '攻击卷轴',
        description: '永久增加 2 点攻击力',
        icon: '📜',
        price: 500,
        priceCurrency: 'gold',
        rewardType: 'attack',
  ...
  },
  {
    id: 'elven_trader',
    title: '精灵商人到访',
    description: '来自精灵森林的商人带来了稀有的魔法物品。',
    merchantName: '精灵商人·露娜',
    merchantAvatar: '🧝‍♀️',
    type: 'special',
    rarity: 'rare',
    icon: '🌿',
    ...
    items: [
      {
        id: 'elven_lucky_charm',
        name: '精灵幸运符',
        description: '永久增加 3 点幸运',
        icon: '🍀',
        price: 800,
        priceCurrency: 'gold',
        rewardType: 'hp',
      ...
      {
        id: 'elven_speed_boots',
        name: '疾风之靴',
        description: '永久增加 3 点速度',
        icon: '👟',
        price: 1000,
        priceCurrency: 'gold',
        rewardType: 'attack',
      ...
      {
        id: 'elven_soul_crystal',
        name: '灵魂水晶',
        description: '获得 3 颗魂珠',
        icon: '💎',
        price: 1500,
        priceCurrency: 'gold',
        rewardType: 'soulOrbs',
  ...
  },
  {
    id: 'dwarf_blacksmith',
    title: '矮人铁匠来访',
    description: '一位技艺精湛的矮人铁匠来到了城镇，愿意出售他的作品。',
    merchantName: '矮人铁匠·铁炉',
    merchantAvatar: '🧔‍♂️',
    type: 'buy',
    rarity: 'epic',
    icon: '⚒️',
    ...
    items: [
      ...
      {
        id: 'dwarf_steel_armor',
        name: '钢铁护甲',
        description: '永久增加 5 点防御力',
        icon: '🛡️',
        price: 2000,
        priceCurrency: 'gold',
        rewardType: 'defense',
      ...
      {
        id: 'dwarf_shield_ring',
        name: '守护之戒',
        description: '永久增加 30 点最大生命',
        icon: '💍',
        price: 1500,
        priceCurrency: 'gold',
        rewardType: 'hp',
  ...
  },
  {
    ...
    title: '神秘商人出现',
    description: '一位神秘的商人出现在城镇中，他出售的物品价格不菲但效果惊人。',
    merchantName: '神秘商人·暗影',
    merchantAvatar: '🎭',
    type: 'special',
    rarity: 'legendary',
    icon: '🌙',
  ...
  },
  {
    id: 'food_merchant',
    title: '美食商人来访',
    description: '一位烹饪大师来到了城镇，出售各种美味佳肴。',
    merchantName: '美食家·胖厨师',
    merchantAvatar: '👨‍🍳',
    type: 'buy',
    rarity: 'common',
    icon: '🍲',
  ...
  },
  {
    id: 'souvenir_seller',
    title: '纪念品商人',
    description: '周游世界的商人带来了各地的珍奇纪念品。',
    merchantName: '旅行家·温斯顿',
    merchantAvatar: '🎒',
    type: 'trade',
    rarity: 'rare',
    icon: '🗺️',
...
export const TOWN_BUILDING_PRODUCTION_INTERVAL = 60000;
...
export {
  RELIC_RARITY_NAMES,
  RELIC_RARITY_COLORS,
  RELIC_RARITY_STAR_COUNTS,
  RELIC_ELEMENT_NAMES,
  RELIC_ELEMENT_ICONS,
  RELIC_ELEMENT_COLORS,
  RELIC_CATEGORY_NAMES,
  RELIC_CATEGORY_ICONS,
} from './types';

export const ALCHEMY_LEVEL_CONFIGS: AlchemyLevelConfig[] = [
  { level: 1, expRequired: 0, successRateBonus: 0, unlockSlotCount: 1, bonusEffectMultiplier: 1.0, title: '学徒炼金师' },
  { level: 2, expRequired: 100, successRateBonus: 0.05, unlockSlotCount: 1, bonusEffectMultiplier: 1.05, title: '见习炼金师' },
  { level: 3, expRequired: 300, successRateBonus: 0.10, unlockSlotCount: 2, bonusEffectMultiplier: 1.10, title: '初级炼金师' },
  { level: 4, expRequired: 600, successRateBonus: 0.15, unlockSlotCount: 2, bonusEffectMultiplier: 1.15, title: '中级炼金师' },
  { level: 5, expRequired: 1000, successRateBonus: 0.20, unlockSlotCount: 2, bonusEffectMultiplier: 1.20, title: '高级炼金师' },
  { level: 6, expRequired: 1800, successRateBonus: 0.25, unlockSlotCount: 3, bonusEffectMultiplier: 1.25, title: '精英炼金师' },
  { level: 7, expRequired: 3000, successRateBonus: 0.30, unlockSlotCount: 3, bonusEffectMultiplier: 1.30, title: '大师炼金师' },
  { level: 8, expRequired: 5000, successRateBonus: 0.35, unlockSlotCount: 3, bonusEffectMultiplier: 1.35, title: '宗师炼金师' },
  { level: 9, expRequired: 8000, successRateBonus: 0.40, unlockSlotCount: 4, bonusEffectMultiplier: 1.40, title: '传奇炼金师' },
  { level: 10, expRequired: 15000, successRateBonus: 0.50, unlockSlotCount: 4, bonusEffectMultiplier: 1.50, title: '神话炼金师' },
];
...
export const POTIONS: Potion[] = [
  {
    ...
    rarity: 'common',
    type: 'healing',
    effects: [{ type: 'hp', value: 50, isPercent: false }],
    duration: 'instant',
    sellPrice: 15,
    combatUsable: true,
    stackLimit: 20,
  },
  {
    ...
    rarity: 'common',
    type: 'mana',
    effects: [{ type: 'mp', value: 30, isPercent: false }],
    duration: 'instant',
    sellPrice: 15,
    combatUsable: true,
    stackLimit: 20,
  },
  {
    ...
    rarity: 'rare',
    type: 'healing',
    effects: [{ type: 'hp', value: 150, isPercent: false }],
    duration: 'instant',
    sellPrice: 60,
    combatUsable: true,
    stackLimit: 15,
  },
  {
    ...
    rarity: 'rare',
    type: 'mana',
    effects: [{ type: 'mp', value: 80, isPercent: false }],
    duration: 'instant',
    sellPrice: 60,
    combatUsable: true,
    stackLimit: 15,
  },
  {
    ...
    rarity: 'epic',
    type: 'healing',
    effects: [{ type: 'hp', value: 400, isPercent: false }],
    duration: 'instant',
    sellPrice: 200,
    combatUsable: true,
    stackLimit: 10,
  },
  {
    ...
    rarity: 'epic',
    type: 'mana',
    effects: [{ type: 'mp', value: 200, isPercent: false }],
    duration: 'instant',
    sellPrice: 200,
    combatUsable: true,
    stackLimit: 10,
  ...
  {
    id: 'potion_attack_elixir',
    name: '攻击强化药剂',
    description: '战斗中提升攻击力，持续3场战斗',
    icon: '⚔️',
    rarity: 'rare',
    type: 'buff',
    effects: [{ type: 'attack', value: 15, isPercent: true }],
    duration: 'battle',
    sellPrice: 120,
    combatUsable: false,
    stackLimit: 10,
  ...
  {
    id: 'potion_defense_elixir',
    name: '防御强化药剂',
    description: '战斗中提升防御力，持续3场战斗',
    icon: '🛡️',
    rarity: 'rare',
    type: 'buff',
  ...
  {
    id: 'potion_speed_elixir',
    name: '迅捷药剂',
    description: '战斗中提升速度，持续3场战斗',
    icon: '💨',
    rarity: 'rare',
    type: 'buff',
    effects: [{ type: 'speed', value: 20, isPercent: true }],
    duration: 'battle',
    sellPrice: 100,
    combatUsable: false,
    stackLimit: 10,
  ...
  {
    id: 'potion_crit_elixir',
    name: '暴击药剂',
    description: '战斗中提升暴击率，持续3场战斗',
    icon: '💥',
    rarity: 'epic',
    type: 'buff',
    effects: [
      { type: 'critRate', value: 15, isPercent: true },
      { type: 'critDamage', value: 30, isPercent: true },
    ],
    duration: 'battle',
    sellPrice: 250,
    combatUsable: false,
  ...
  {
    id: 'potion_damage_reduction',
    name: '坚韧药剂',
    description: '战斗中减少受到的伤害，持续3场战斗',
    icon: '🔰',
    rarity: 'epic',
    type: 'buff',
    effects: [{ type: 'damageReduction', value: 20, isPercent: true }],
    duration: 'battle',
    sellPrice: 250,
    combatUsable: false,
    stackLimit: 5,
  },
  {
    id: 'potion_exp_boost',
    name: '经验增幅药剂',
    description: '提升经验获取30%，持续10分钟',
    icon: '⭐',
    rarity: 'rare',
    type: 'buff',
    effects: [{ type: 'expBonus', value: 30, isPercent: true }],
    duration: 'timed',
    durationSeconds: 600,
    sellPrice: 150,
    combatUsable: false,
  ...
  {
    id: 'potion_gold_boost',
    name: '财富药剂',
    description: '提升金币获取30%，持续10分钟',
    icon: '💰',
    rarity: 'rare',
    type: 'buff',
    effects: [{ type: 'goldBonus', value: 30, isPercent: true }],
    duration: 'timed',
    durationSeconds: 600,
    sellPrice: 150,
    combatUsable: false,
  ...
  },
  {
    id: 'potion_antidote',
    name: '万能解毒剂',
    description: '清除所有负面状态并恢复少量生命',
    icon: '🌿',
    rarity: 'common',
    type: 'cure',
    effects: [{ type: 'hp', value: 30, isPercent: false }],
    duration: 'instant',
    sellPrice: 25,
    combatUsable: true,
    stackLimit: 20,
  ...
  {
    id: 'potion_dragon_blood',
    name: '龙血药剂',
    description: '大幅提升全属性，持续3场战斗',
    icon: '🐉',
    rarity: 'legendary',
    type: 'buff',
    effects: [
      { type: 'attack', value: 20, isPercent: true },
      { type: 'defense', value: 20, isPercent: true },
      { type: 'speed', value: 10, isPercent: true },
      { type: 'maxHp', value: 25, isPercent: true },
    ],
    duration: 'battle',
    sellPrice: 800,
    combatUsable: false,
  ...
  {
    id: 'potion_phoenix_tear',
    name: '凤凰之泪',
    description: '立即恢复50%最大生命和魔力，并获得短暂伤害减免',
    icon: '🪶',
    rarity: 'legendary',
    type: 'special',
    effects: [
      { type: 'hp', value: 50, isPercent: true },
      { type: 'mp', value: 50, isPercent: true },
      { type: 'damageReduction', value: 15, isPercent: true },
    ],
    duration: 'battle',
    sellPrice: 1000,
    combatUsable: true,
  ...
  {
    id: 'potion_soul_attract',
    name: '魂引药剂',
    description: '提升魂珠获取20%，持续10分钟',
    icon: '✨',
    rarity: 'epic',
    type: 'buff',
    effects: [{ type: 'soulOrbBonus', value: 20, isPercent: true }],
    duration: 'timed',
    durationSeconds: 600,
    sellPrice: 300,
    combatUsable: false,
  ...
  {
    id: 'potion_luck_elixir',
    name: '幸运药剂',
    description: '提升幸运值，持续3场战斗',
    icon: '🍀',
    rarity: 'rare',
    type: 'buff',
    effects: [{ type: 'luck', value: 10, isPercent: true }],
    duration: 'battle',
    sellPrice: 80,
    combatUsable: false,
    stackLimit: 10,
...
export const ALCHEMY_RECIPES: AlchemyRecipe[] = [
  {
    ...
    name: '小型治疗药水配方',
    description: '用普通草药炼制基础治疗药水',
    icon: '📜',
    rarity: 'common',
    inputs: [{ materialId: 'herb_common', count: 3 }],
    goldCost: 10,
    outputPotionId: 'potion_minor_healing',
    outputCount: 2,
  ...
  {
    id: 'recipe_minor_mana',
    name: '小型魔力药水配方',
    description: '用魔晶碎片炼制基础魔力药水',
    icon: '📜',
    rarity: 'common',
    inputs: [{ materialId: 'magic_crystal_shard', count: 1 }, { materialId: 'herb_common', count: 1 }],
    goldCost: 15,
    outputPotionId: 'potion_minor_mana',
    outputCount: 2,
    requiredAlchemyLevel: 1,
    successRate: 0.90,
    category: '基础药剂',
  },
  {
    id: 'recipe_antidote',
    name: '万能解毒剂配方',
    description: '用草药炼制解毒剂',
    icon: '📜',
    rarity: 'common',
    inputs: [{ materialId: 'herb_common', count: 2 }, { materialId: 'spider_silk', count: 1 }],
    goldCost: 20,
    outputPotionId: 'potion_antidote',
    outputCount: 2,
    requiredAlchemyLevel: 1,
    successRate: 0.90,
    category: '基础药剂',
  },
  {
    id: 'recipe_healing',
    name: '治疗药水配方',
    description: '用高级草药和魔晶炼制治疗药水',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'herb_common', count: 5 }, { materialId: 'magic_crystal_shard', count: 2 }],
    goldCost: 50,
    outputPotionId: 'potion_healing',
    outputCount: 2,
  ...
  },
  {
    id: 'recipe_mana',
    name: '魔力药水配方',
    description: '用魔晶碎片和符石炼制魔力药水',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'magic_crystal_shard', count: 3 }, { materialId: 'ancient_rune_stone', count: 1 }],
    goldCost: 50,
    outputPotionId: 'potion_mana',
    outputCount: 2,
    requiredAlchemyLevel: 3,
    successRate: 0.80,
    category: '进阶药剂',
  ...
  {
    id: 'recipe_attack_elixir',
    name: '攻击强化药剂配方',
    description: '用野狼皮毛和魔晶碎片强化攻击力',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'wolf_pelt', count: 3 }, { materialId: 'magic_crystal_shard', count: 2 }],
    goldCost: 80,
    outputPotionId: 'potion_attack_elixir',
    outputCount: 1,
  ...
  {
    id: 'recipe_defense_elixir',
    name: '防御强化药剂配方',
    description: '用铁矿石和古代符石强化防御力',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'iron_ore', count: 3 }, { materialId: 'ancient_rune_stone', count: 2 }],
    goldCost: 80,
    outputPotionId: 'potion_defense_elixir',
    outputCount: 1,
    requiredAlchemyLevel: 4,
    successRate: 0.70,
    category: '强化药剂',
  },
  {
    ...
    name: '迅捷药剂配方',
    description: '用蜘蛛丝和魔晶碎片提升速度',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'spider_silk', count: 3 }, { materialId: 'magic_crystal_shard', count: 2 }],
    goldCost: 70,
    outputPotionId: 'potion_speed_elixir',
    outputCount: 1,
    requiredAlchemyLevel: 4,
    successRate: 0.75,
    category: '强化药剂',
  ...
  {
    id: 'recipe_luck_elixir',
    name: '幸运药剂配方',
    description: '用古代符石和魔晶碎片提升幸运',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'ancient_rune_stone', count: 1 }, { materialId: 'magic_crystal_shard', count: 2 }, { materialId: 'herb_common', count: 2 }],
    goldCost: 60,
    outputPotionId: 'potion_luck_elixir',
    outputCount: 1,
    requiredAlchemyLevel: 3,
    successRate: 0.75,
    category: '强化药剂',
  },
  {
    id: 'recipe_exp_boost',
    name: '经验增幅药剂配方',
    description: '用古代符石和魔晶碎片增幅经验获取',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'ancient_rune_stone', count: 2 }, { materialId: 'magic_crystal_shard', count: 3 }],
    goldCost: 100,
    outputPotionId: 'potion_exp_boost',
    outputCount: 1,
  ...
  {
    id: 'recipe_gold_boost',
    name: '财富药剂配方',
    description: '用铁矿石和古代符石吸引财富',
    icon: '📜',
    rarity: 'rare',
    inputs: [{ materialId: 'iron_ore', count: 3 }, { materialId: 'ancient_rune_stone', count: 2 }, { materialId: 'herb_common', count: 2 }],
    goldCost: 100,
    outputPotionId: 'potion_gold_boost',
    outputCount: 1,
    requiredAlchemyLevel: 5,
    successRate: 0.65,
    category: '增益药剂',
  ...
  {
    id: 'recipe_greater_healing',
    name: '强效治疗药水配方',
    description: '用龙鳞碎片和凤凰羽毛炼制强力治疗药水',
    icon: '📜',
    rarity: 'epic',
    inputs: [{ materialId: 'dragon_scale', count: 1 }, { materialId: 'phoenix_feather', count: 1 }, { materialId: 'herb_common', count: 5 }],
    goldCost: 200,
    outputPotionId: 'potion_greater_healing',
    outputCount: 1,
  ...
  {
    id: 'recipe_greater_mana',
    name: '强效魔力药水配方',
    description: '用巫妖骸骨和魔晶碎片炼制强力魔力药水',
    icon: '📜',
    rarity: 'epic',
    inputs: [{ materialId: 'lich_bone', count: 1 }, { materialId: 'magic_crystal_shard', count: 5 }],
    goldCost: 200,
    outputPotionId: 'potion_greater_mana',
    outputCount: 1,
    requiredAlchemyLevel: 6,
    successRate: 0.55,
    category: '高级药剂',
  ...
  {
    id: 'recipe_crit_elixir',
    name: '暴击药剂配方',
    description: '用巫妖骸骨和龙鳞碎片炼制暴击药剂',
    icon: '📜',
    rarity: 'epic',
    inputs: [{ materialId: 'lich_bone', count: 2 }, { materialId: 'dragon_scale', count: 1 }],
    goldCost: 300,
    outputPotionId: 'potion_crit_elixir',
    outputCount: 1,
  ...
  {
    id: 'recipe_damage_reduction',
    name: '坚韧药剂配方',
    description: '用龙鳞碎片和铁矿石炼制减伤药剂',
    icon: '📜',
    rarity: 'epic',
    inputs: [{ materialId: 'dragon_scale', count: 2 }, { materialId: 'iron_ore', count: 5 }],
    goldCost: 300,
    outputPotionId: 'potion_damage_reduction',
    outputCount: 1,
    requiredAlchemyLevel: 7,
    successRate: 0.45,
    category: '高级药剂',
  ...
  {
    id: 'recipe_soul_attract',
    name: '魂引药剂配方',
    description: '用时之沙和巫妖骸骨吸引灵魂能量',
    icon: '📜',
    rarity: 'epic',
    inputs: [{ materialId: 'time_sand', count: 1 }, { materialId: 'lich_bone', count: 1 }, { materialId: 'magic_crystal_shard', count: 3 }],
    goldCost: 350,
    outputPotionId: 'potion_soul_attract',
    outputCount: 1,
    requiredAlchemyLevel: 7,
    successRate: 0.40,
    category: '增益药剂',
  },
  {
    ...
    name: '龙血药剂配方',
    description: '用龙王魔核和龙鳞碎片炼制传说中的龙血药剂',
    icon: '📜',
    rarity: 'legendary',
    inputs: [{ materialId: 'dragon_king_core', count: 1 }, { materialId: 'dragon_scale', count: 3 }, { materialId: 'phoenix_feather', count: 2 }],
    goldCost: 1000,
    outputPotionId: 'potion_dragon_blood',
    outputCount: 1,
  ...
  {
    id: 'recipe_phoenix_tear',
    name: '凤凰之泪配方',
    description: '用凤凰羽毛和世界树之心炼制传说中的凤凰之泪',
    icon: '📜',
    rarity: 'legendary',
    inputs: [{ materialId: 'phoenix_feather', count: 3 }, { materialId: 'world_tree_heart', count: 1 }, { materialId: 'time_sand', count: 1 }],
    goldCost: 1500,
    outputPotionId: 'potion_phoenix_tear',
    outputCount: 1,
...
export const ALCHEMY_RARITY_COLORS: Record<string, string> = {
  common: '#9ca3af',
  rare: '#3b82f6',
  epic: '#8b5cf6',
  legendary: '#f59e0b',
...
export const ALCHEMY_RARITY_NAMES: Record<string, string> = {
  common: '普通',
  rare: '稀有',
  epic: '史诗',
  legendary: '传说',
...
export const POTION_TYPE_ICONS: Record<string, string> = {
  healing: '❤️',
  mana: '💙',
  buff: '⚡',
  cure: '🌿',
...
export const BUFF_DURATION_NAMES: Record<string, string> = {
  instant: '即时',
  battle: '战斗持续',
  timed: '限时',
};

export const ALCHEMY_CRAFT_FAIL_REFUND_RATE = 0.3;

export const ALCHEMY_BATTLE_BUFF_DURATION = 3;

export const ALCHEMY_EXP_PER_CRAFT: Record<string, number> = {
  common: 10,
  rare: 30,
  epic: 80,
  legendary: 200,
...
export const ACHIEVEMENTS: Achievement[] = [
  {
    ...
    category: 'monster',
    rarity: 'common',
    conditions: [{ type: 'monster_kills', target: 1, description: '击败 1 只怪物' }],
    rewards: [
      { type: 'gold', value: 100 },
      { type: 'exp', value: 50 },
    ],
  },
  {
    ...
    name: '怪物猎人',
    description: '累计击败 10 只怪物',
    icon: '🗡️',
    category: 'monster',
    rarity: 'common',
    conditions: [{ type: 'monster_kills', target: 10, description: '击败 10 只怪物' }],
    rewards: [
      { type: 'gold', value: 300 },
      { type: 'exp', value: 150 },
    ],
  },
  {
    ...
    name: '猎杀专家',
    description: '累计击败 50 只怪物',
    icon: '💀',
    category: 'monster',
    rarity: 'rare',
    conditions: [{ type: 'monster_kills', target: 50, description: '击败 50 只怪物' }],
    rewards: [
      { type: 'gold', value: 800 },
      { type: 'soulOrbs', value: 2 },
      { type: 'attack', value: 2 },
  ...
  },
  {
    ...
    name: '屠戮者',
    description: '累计击败 200 只怪物',
    icon: '☠️',
    category: 'monster',
    rarity: 'epic',
    conditions: [{ type: 'monster_kills', target: 200, description: '击败 200 只怪物' }],
    rewards: [
      { type: 'gold', value: 2000 },
      { type: 'soulOrbs', value: 5 },
      { type: 'attack', value: 5 },
  ...
  {
    id: 'monster_hunter_1000',
    name: '千斩之魂',
    description: '累计击败 1000 只怪物',
    icon: '🩸',
    category: 'monster',
    rarity: 'legendary',
    conditions: [{ type: 'monster_kills', target: 1000, description: '击败 1000 只怪物' }],
    rewards: [
      { type: 'gold', value: 10000 },
      { type: 'soulOrbs', value: 15 },
      { type: 'attack', value: 10 },
  ...
  },
  {
    id: 'elite_slayer',
    name: '精英克星',
    description: '击败 10 只精英怪物',
    icon: '💎',
    category: 'monster',
    rarity: 'rare',
    conditions: [{ type: 'monster_tier_kills', target: 10, monsterTier: 'elite', description: '击败 10 只精英怪物' }],
    rewards: [
      { type: 'gold', value: 1000 },
      { type: 'soulOrbs', value: 3 },
      { type: 'defense', value: 3 },
  ...
  },
  {
    id: 'boss_slayer',
    name: '首领终结者',
    description: '击败 5 只首领怪物',
    icon: '👑',
    category: 'monster',
    rarity: 'epic',
    conditions: [{ type: 'monster_tier_kills', target: 5, monsterTier: 'boss', description: '击败 5 只首领怪物' }],
    rewards: [
      { type: 'gold', value: 5000 },
      { type: 'soulOrbs', value: 10 },
      { type: 'attack', value: 8 },
  ...
  },
  {
    id: 'monster_codex_5',
    name: '博物学徒',
    description: '解锁 5 种怪物图鉴',
    icon: '📖',
    category: 'collection',
    rarity: 'common',
    conditions: [{ type: 'monster_codex_unlocked', target: 5, description: '解锁 5 种怪物' }],
    rewards: [
      { type: 'gold', value: 500 },
      { type: 'exp', value: 200 },
    ],
  ...
  {
    id: 'monster_codex_all',
    name: '怪物图鉴大师',
    description: '解锁全部怪物图鉴',
    icon: '📚',
    category: 'collection',
    rarity: 'epic',
    conditions: [{ type: 'monster_codex_unlocked', target: 16, description: '解锁全部怪物' }],
    rewards: [
      { type: 'gold', value: 5000 },
      { type: 'soulOrbs', value: 8 },
      { type: 'luck', value: 3 },
  ...
  },
  {
    id: 'first_event',
    name: '命运之轮',
    description: '首次触发随机事件',
    icon: '🎲',
    category: 'event',
    rarity: 'common',
    conditions: [{ type: 'event_triggered', target: 1, description: '触发 1 次事件' }],
    rewards: [
      { type: 'gold', value: 80 },
      { type: 'exp', value: 40 },
    ],
  ...
  {
    id: 'event_explorer_10',
    name: '事件探险家',
    description: '触发 10 次随机事件',
    icon: '🗺️',
    category: 'event',
    rarity: 'common',
    conditions: [{ type: 'event_triggered', target: 10, description: '触发 10 次事件' }],
    rewards: [
      { type: 'gold', value: 400 },
      { type: 'exp', value: 200 },
    ],
  ...
  {
    id: 'event_explorer_50',
    name: '奇遇不断',
    description: '触发 50 次随机事件',
    icon: '✨',
    category: 'event',
    rarity: 'rare',
    conditions: [{ type: 'event_triggered', target: 50, description: '触发 50 次事件' }],
    rewards: [
      { type: 'gold', value: 1500 },
      { type: 'soulOrbs', value: 3 },
      { type: 'luck', value: 2 },
  ...
  },
  {
    id: 'event_codex_5',
    name: '事件收藏家',
    description: '解锁 5 种事件图鉴',
    icon: '📜',
    category: 'collection',
    rarity: 'rare',
    conditions: [{ type: 'event_codex_unlocked', target: 5, description: '解锁 5 种事件' }],
    rewards: [
      { type: 'gold', value: 800 },
      { type: 'exp', value: 400 },
    ],
  },
  {
    id: 'event_choices_20',
    name: '抉择之人',
    description: '做出 20 次事件选择',
    icon: '🤔',
    category: 'event',
    rarity: 'rare',
    conditions: [{ type: 'event_choices', target: 20, description: '做出 20 次选择' }],
    rewards: [
      { type: 'gold', value: 1000 },
      { type: 'soulOrbs', value: 2 },
      { type: 'speed', value: 2 },
  ...
  },
  {
    ...
    category: 'companion',
    rarity: 'common',
    conditions: [{ type: 'companion_recruited', target: 1, description: '招募 1 位伙伴' }],
    rewards: [
      { type: 'gold', value: 200 },
      { type: 'exp', value: 100 },
    ],
  ...
  {
    id: 'companion_collector_3',
    name: '三人小队',
    description: '招募 3 位伙伴',
    icon: '👥',
    category: 'companion',
    rarity: 'common',
    conditions: [{ type: 'companion_recruited', target: 3, description: '招募 3 位伙伴' }],
    rewards: [
      { type: 'gold', value: 500 },
      { type: 'exp', value: 250 },
    ],
  ...
  {
    id: 'companion_collector_5',
    name: '冒险团队',
    description: '招募 5 位伙伴',
    icon: '🎪',
    category: 'companion',
    rarity: 'rare',
    conditions: [{ type: 'companion_recruited', target: 5, description: '招募 5 位伙伴' }],
    rewards: [
      { type: 'gold', value: 1500 },
      { type: 'soulOrbs', value: 3 },
      { type: 'defense', value: 3 },
  ...
  {
    id: 'companion_codex_all',
    name: '伙伴图鉴大师',
    description: '解锁全部伙伴图鉴',
    icon: '📖',
    category: 'collection',
    rarity: 'epic',
    conditions: [{ type: 'companion_codex_unlocked', target: 10, description: '解锁全部伙伴' }],
    rewards: [
      { type: 'gold', value: 5000 },
      { type: 'soulOrbs', value: 10 },
      { type: 'hp', value: 50 },
  ...
  {
    id: 'companion_star_master',
    name: '升星达人',
    description: '拥有一个 5 星伙伴',
    icon: '⭐',
    category: 'companion',
    rarity: 'epic',
    conditions: [{ type: 'companion_stars', target: 5, description: '伙伴达到 5 星' }],
    rewards: [
      { type: 'gold', value: 3000 },
      { type: 'soulOrbs', value: 5 },
      { type: 'attack', value: 5 },
  ...
  },
  {
    ...
    category: 'rebirth',
    rarity: 'rare',
    conditions: [{ type: 'rebirth_count', target: 1, description: '转生 1 次' }],
    rewards: [
      { type: 'gold', value: 1000 },
      { type: 'soulOrbs', value: 5 },
      { type: 'attack', value: 3 },
  ...
  },
  {
    ...
    category: 'rebirth',
    rarity: 'epic',
    conditions: [{ type: 'rebirth_count', target: 5, description: '转生 5 次' }],
    rewards: [
      { type: 'gold', value: 5000 },
      { type: 'soulOrbs', value: 15 },
      { type: 'defense', value: 8 },
  ...
  },
  {
    id: 'rebirth_master',
    name: '轮回主宰',
    description: '完成 10 次转生',
    icon: '♾️',
    category: 'rebirth',
    rarity: 'legendary',
    conditions: [{ type: 'rebirth_count', target: 10, description: '转生 10 次' }],
    rewards: [
  ...
  },
  {
    id: 'rebirth_bonus_50',
    name: '转生祝福',
    description: '累计转生加成达到 50%',
    icon: '✨',
    category: 'rebirth',
    rarity: 'epic',
    conditions: [{ type: 'rebirth_bonus_total', target: 50, description: '转生加成达到 50%' }],
    rewards: [
      { type: 'gold', value: 8000 },
      { type: 'soulOrbs', value: 10 },
      { type: 'luck', value: 5 },
  ...
  },
  {
    ...
    category: 'combat',
    rarity: 'common',
    conditions: [{ type: 'level_reached', target: 10, description: '达到 10 级' }],
    rewards: [
      { type: 'gold', value: 300 },
      { type: 'exp', value: 200 },
    ],
  },
  {
    ...
    category: 'combat',
    rarity: 'rare',
    conditions: [{ type: 'level_reached', target: 30, description: '达到 30 级' }],
    rewards: [
      { type: 'gold', value: 2000 },
      { type: 'soulOrbs', value: 5 },
      { type: 'attack', value: 3 },
  ...
  },
  {
    ...
    category: 'combat',
    rarity: 'epic',
    conditions: [{ type: 'level_reached', target: 50, description: '达到 50 级' }],
    rewards: [
      { type: 'gold', value: 8000 },
      { type: 'soulOrbs', value: 10 },
      { type: 'attack', value: 8 },
  ...
  },
  {
    ...
    rarity: 'rare',
    conditions: [{ type: 'gold_earned', target: 10000, description: '获得 10000 金币' }],
    rewards: [
      { type: 'gold', value: 2000 },
      { type: 'luck', value: 2 },
    ],
  },
  {
    id: 'soul_collector',
    name: '灵魂收集者',
    description: '累计获得 50 魂珠',
    icon: '🔮',
    category: 'exploration',
    rarity: 'epic',
    conditions: [{ type: 'soul_orbs_earned', target: 50, description: '获得 50 魂珠' }],
    rewards: [
      { type: 'soulOrbs', value: 10 },
      { type: 'exp', value: 1000 },
    ],
  },
  {
    id: 'area_explorer',
    name: '探索先锋',
    description: '解锁 3 个地图区域',
    icon: '🗺️',
    category: 'exploration',
    rarity: 'rare',
    conditions: [{ type: 'area_unlocked', target: 3, description: '解锁 3 个区域' }],
    rewards: [
      { type: 'gold', value: 1000 },
      { type: 'exp', value: 500 },
      { type: 'speed', value: 2 },
  ...
  },
  {
    id: 'power_100',
    name: '战力新星',
    description: '总战力达到 100',
    icon: '💪',
    category: 'combat',
    rarity: 'common',
    conditions: [{ type: 'total_power', target: 100, description: '总战力达到 100' }],
    rewards: [
      { type: 'gold', value: 300 },
      { type: 'exp', value: 150 },
    ],
  },
  {
    id: 'power_500',
    name: '强者之名',
    description: '总战力达到 500',
    icon: '⚡',
    category: 'combat',
    rarity: 'rare',
    conditions: [{ type: 'total_power', target: 500, description: '总战力达到 500' }],
    rewards: [
      { type: 'gold', value: 1500 },
      { type: 'soulOrbs', value: 3 },
      { type: 'attack', value: 5 },
  ...
  },
  {
    id: 'power_2000',
    name: '传奇战士',
    description: '总战力达到 2000',
    icon: '🔥',
    category: 'combat',
    rarity: 'epic',
    conditions: [{ type: 'total_power', target: 2000, description: '总战力达到 2000' }],
    rewards: [
      { type: 'gold', value: 5000 },
      { type: 'soulOrbs', value: 10 },
      { type: 'attack', value: 10 },
  ...
  },
  {
    ...
    name: '收藏大师',
    description: '解锁怪物、事件、伙伴图鉴各 5 种以上',
    icon: '🏛️',
    category: 'collection',
    rarity: 'legendary',
    conditions: [
      { type: 'monster_codex_unlocked', target: 5, description: '解锁 5 种怪物' },
      { type: 'event_codex_unlocked', target: 5, description: '解锁 5 种事件' },
      { type: 'companion_codex_unlocked', target: 5, description: '解锁 5 种伙伴' },
    ],
    rewards: [
      { type: 'gold', value: 10000 },
      { type: 'soulOrbs', value: 20 },
...
export const STORYLINES: Storyline[] = [
  {
    ...
    name: '命运的开端',
    subtitle: '第一章：觉醒',
    description: '你意外穿越到这个异世界，命运的齿轮开始转动...',
    type: 'main',
    icon: '⚔️',
    color: '#f59e0b',
    bgColor: '#fef3c7',
    startNodeId: 'ms1_node_1',
    endNodeIds: ['ms1_node_ending_good', 'ms1_node_ending_neutral', 'ms1_node_ending_bad'],
    order: 1,
    nodes: [
      {
        id: 'ms1_node_1',
        nodeType: 'dialogue',
        title: '苏醒',
        description: '你在一片陌生的森林中醒来，记忆模糊...',
        icon: '🌲',
        nextNodeIds: ['ms1_node_2'],
        previousNodeIds: [],
        rewards: [{ type: 'exp', value: 50 }],
      },
      {
        id: 'ms1_node_2',
        nodeType: 'choice',
        title: '道路抉择',
        description: '前方出现了分岔路，你会选择哪一条？',
        icon: '🔀',
        nextNodeIds: ['ms1_node_3_light', 'ms1_node_3_shadow'],
        previousNodeIds: ['ms1_node_1'],
        choices: [
          {
            id: 'light_path',
            text: '走向阳光明媚的道路',
            nextNodeId: 'ms1_node_3_light',
            alignment: 'light',
          },
          {
            id: 'shadow_path',
            text: '走向幽暗神秘的小径',
            nextNodeId: 'ms1_node_3_shadow',
            alignment: 'shadow',
          },
        ],
      },
      {
        ...
        nodeType: 'event',
        title: '精灵的求助',
        description: '你遇到了一位受伤的精灵，她正在被哥布林追击...',
        icon: '🧝',
        nextNodeIds: ['ms1_node_4'],
        previousNodeIds: ['ms1_node_2'],
        eventId: 'forest_spirit',
        alignment: 'light',
        branchId: 'light_branch',
        consequenceTags: ['spirit_friend'],
        companionAffinity: [{ companionId: 'forest_archer', value: 10 }],
      },
      {
        id: 'ms1_node_3_shadow',
        nodeType: 'event',
        title: '暗影法师',
        description: '一位神秘的暗黑法师出现在你面前，他似乎对你很感兴趣...',
        icon: '🧙',
        nextNodeIds: ['ms1_node_4'],
        previousNodeIds: ['ms1_node_2'],
        eventId: 'old_sage',
        alignment: 'shadow',
        branchId: 'shadow_branch',
        consequenceTags: ['dark_affinity'],
        companionAffinity: [{ companionId: 'dark_mage', value: 10 }],
      },
      {
        id: 'ms1_node_4',
        nodeType: 'battle',
        title: '首战告捷',
        description: '是时候检验一下你的实力了！',
        icon: '⚔️',
        nextNodeIds: ['ms1_node_5'],
        previousNodeIds: ['ms1_node_3_light', 'ms1_node_3_shadow'],
        battleConfig: {
          areaId: 'forest',
          minTier: 'normal',
        },
      ...
      },
      {
        ...
        nodeType: 'choice',
        title: '命运的分岔',
        description: '经历了这些冒险，你对未来有了更多的思考...',
        icon: '🌟',
        nextNodeIds: ['ms1_node_6_good', 'ms1_node_6_neutral', 'ms1_node_6_bad'],
        previousNodeIds: ['ms1_node_4'],
        requiredLevel: 5,
        choices: [
          {
            id: 'hero_path',
            text: '立志成为拯救世界的英雄',
            nextNodeId: 'ms1_node_6_good',
            alignment: 'light',
            requiredTags: ['spirit_friend'],
          },
          {
            id: 'neutral_path',
            text: '只想过平静的生活',
            nextNodeId: 'ms1_node_6_neutral',
          },
          {
            id: 'dark_path',
            text: '追求强大的力量，不惜一切代价',
            nextNodeId: 'ms1_node_6_bad',
            alignment: 'shadow',
            requiredTags: ['dark_affinity'],
          },
        ],
      },
      {
        ...
        nodeType: 'dialogue',
        title: '英雄之路',
        description: '你决心踏上英雄的旅程，为这个世界带来光明...',
        icon: '✨',
        nextNodeIds: ['ms1_node_ending_good'],
        previousNodeIds: ['ms1_node_5'],
        rewards: [{ type: 'exp', value: 200 }],
        branchId: 'light_branch',
      },
      {
        id: 'ms1_node_6_neutral',
        nodeType: 'dialogue',
        title: '平凡之路',
        description: '你选择了一条平凡但安稳的道路...',
        icon: '🏠',
        nextNodeIds: ['ms1_node_ending_neutral'],
        previousNodeIds: ['ms1_node_5'],
      ...
      },
      {
        ...
        nodeType: 'dialogue',
        title: '暗影之路',
        description: '你被黑暗力量所吸引，开始追寻禁忌的力量...',
        icon: '🌑',
        nextNodeIds: ['ms1_node_ending_bad'],
        previousNodeIds: ['ms1_node_5'],
        rewards: [{ type: 'attack', value: 5 }],
        branchId: 'shadow_branch',
      },
      {
        id: 'ms1_node_ending_good',
        nodeType: 'ending',
        title: '希望之光',
        description: '你成为了传说中的英雄，为世界带来了和平。',
        icon: '👑',
        bgColor: '#fef3c7',
        previousNodeIds: ['ms1_node_6_good'],
        isEnding: true,
        endingType: 'good',
        unlockEndingIds: ['ending_good_hero'],
        rewards: [
          { type: 'exp', value: 500 },
          { type: 'gold', value: 1000 },
          { type: 'soulOrbs', value: 5 },
      ...
      {
        id: 'ms1_node_ending_neutral',
        nodeType: 'ending',
        title: '平静生活',
        description: '你过上了平静的生活，虽然平凡但幸福。',
        icon: '🏡',
        bgColor: '#e5e7eb',
        previousNodeIds: ['ms1_node_6_neutral'],
        isEnding: true,
        endingType: 'neutral',
        unlockEndingIds: ['ending_neutral_calm'],
        rewards: [
          { type: 'exp', value: 200 },
          { type: 'gold', value: 500 },
        ],
      ...
      {
        id: 'ms1_node_ending_bad',
        nodeType: 'ending',
        title: '堕入黑暗',
        description: '你被黑暗吞噬，成为了新的黑暗领主...',
        icon: '💀',
        bgColor: '#fecaca',
        previousNodeIds: ['ms1_node_6_bad'],
        isEnding: true,
        endingType: 'bad',
        unlockEndingIds: ['ending_bad_darklord'],
        rewards: [
          { type: 'exp', value: 300 },
          { type: 'attack', value: 10 },
        ],
    ...
    branches: [
      {
        id: 'light_branch',
        name: '光明路线',
        description: '选择光明，成为守护世界的英雄',
        icon: '☀️',
        color: '#fbbf24',
        startNodeId: 'ms1_node_3_light',
        endNodeId: 'ms1_node_ending_good',
        alignment: 'light',
      },
      {
        id: 'shadow_branch',
        name: '暗影路线',
        description: '追随暗影，获得强大的力量',
        icon: '🌙',
        color: '#7c3aed',
        startNodeId: 'ms1_node_3_shadow',
        endNodeId: 'ms1_node_ending_bad',
        alignment: 'shadow',
      },
    ],
    unlockEndingIds: ['ending_good_hero', 'ending_neutral_calm', 'ending_bad_darklord'],
  },
  {
    id: 'companion_story_archer',
    name: '精灵弓手的誓言',
    subtitle: '伙伴剧情：森林弓手',
    description: '与精灵弓手艾莉娅一起冒险，揭开她过去的秘密...',
    type: 'companion',
    icon: '🏹',
    color: '#ec4899',
    bgColor: '#fce7f3',
    startNodeId: 'csa_node_1',
    endNodeIds: ['csa_node_ending'],
    companionId: 'forest_archer',
    order: 1,
    requiredLevel: 10,
    nodes: [
      {
        ...
        nodeType: 'dialogue',
        title: '神秘的委托',
        description: '森林弓手艾莉娅找到你，似乎有重要的事情相求...',
        icon: '💬',
        nextNodeIds: ['csa_node_2'],
        previousNodeIds: [],
        requiredAffinity: [{ companionId: 'forest_archer', minValue: 10 }],
      },
      {
        id: 'csa_node_2',
        nodeType: 'event',
        title: '森林危机',
        description: '艾莉娅的家乡正受到黑暗势力的威胁...',
        icon: '🌲',
        nextNodeIds: ['csa_node_3'],
        previousNodeIds: ['csa_node_1'],
        companionAffinity: [{ companionId: 'forest_archer', value: 15 }],
        consequenceTags: ['forest_crisis'],
      },
      {
        id: 'csa_node_3',
        nodeType: 'choice',
        title: '援助之选',
        description: '你会如何帮助艾莉娅？',
        icon: '🤝',
        nextNodeIds: ['csa_node_4_battle', 'csa_node_4_diploma'],
        previousNodeIds: ['csa_node_2'],
        choices: [
          {
            id: 'battle_help',
            text: '直接参战，击退入侵者',
            nextNodeId: 'csa_node_4_battle',
            alignment: 'light',
          },
          {
            id: 'diploma_help',
            text: '尝试谈判，寻找和平解决方案',
            nextNodeId: 'csa_node_4_diploma',
            alignment: 'order',
          },
        ],
      },
      {
        id: 'csa_node_4_battle',
        nodeType: 'battle',
        title: '森林守卫战',
        description: '为了森林的和平，战斗吧！',
        icon: '⚔️',
        nextNodeIds: ['csa_node_ending'],
        previousNodeIds: ['csa_node_3'],
        battleConfig: {
          areaId: 'forest',
          bossOnly: true,
        },
        ...
        companionAffinity: [{ companionId: 'forest_archer', value: 20 }],
      },
      {
        id: 'csa_node_4_diploma',
        nodeType: 'dialogue',
        title: '和平协议',
        description: '通过你的智慧，双方达成了和平协议...',
        icon: '📜',
        nextNodeIds: ['csa_node_ending'],
        previousNodeIds: ['csa_node_3'],
        rewards: [
        ...
        companionAffinity: [{ companionId: 'forest_archer', value: 25 }],
        consequenceTags: ['peace_maker'],
      },
      {
        id: 'csa_node_ending',
        nodeType: 'ending',
        title: '永恒的羁绊',
        description: '你与艾莉娅结下了深厚的友谊，她发誓永远追随你...',
        icon: '💝',
        bgColor: '#fce7f3',
        previousNodeIds: ['csa_node_4_battle', 'csa_node_4_diploma'],
        isEnding: true,
        endingType: 'good',
        unlockEndingIds: ['ending_companion_archer'],
        rewards: [
          { type: 'exp', value: 500 },
          { type: 'soulOrbs', value: 3 },
        ],
  ...
  {
    id: 'secret_story_ancient',
    name: '远古的秘密',
    subtitle: '隐藏剧情',
    description: '揭开这个世界最深层的秘密...',
    type: 'secret',
    icon: '🔮',
    color: '#8b5cf6',
    bgColor: '#ede9fe',
    startNodeId: 'ss_node_1',
    endNodeIds: ['ss_node_true_ending'],
    order: 1,
    hidden: true,
    requiredTags: ['ancient_knowledge', 'guardian_blessed'],
    requiredLevel: 30,
    nodes: [
      {
        id: 'ss_node_1',
        nodeType: 'event',
        title: '神秘符文',
        description: '你在遗迹深处发现了一组从未见过的符文...',
        icon: '📜',
        nextNodeIds: ['ss_node_2'],
        previousNodeIds: [],
        requiredTags: ['ancient_knowledge'],
      },
      {
        id: 'ss_node_2',
        nodeType: 'choice',
        title: '真相的代价',
        description: '追寻真相需要付出代价，你准备好了吗？',
        icon: '❓',
        nextNodeIds: ['ss_node_3'],
        previousNodeIds: ['ss_node_1'],
        choices: [
          {
            id: 'seek_truth',
            text: '无论如何，我要知道真相',
            nextNodeId: 'ss_node_3',
            alignment: 'chaos',
          },
        ],
      },
      {
        ...
        nodeType: 'battle',
        title: '远古试炼',
        description: '守护者要考验你是否有资格知晓真相...',
        icon: '⚔️',
        nextNodeIds: ['ss_node_true_ending'],
        previousNodeIds: ['ss_node_2'],
        battleConfig: {
          areaId: 'ruins',
          bossOnly: true,
        },
      ...
      {
        id: 'ss_node_true_ending',
        nodeType: 'ending',
        title: '世界的真相',
        description: '你终于知晓了这个世界的终极秘密...原来一切都是轮回的一部分。',
        icon: '👁️',
        bgColor: '#ede9fe',
        previousNodeIds: ['ss_node_3'],
        isEnding: true,
        endingType: 'true',
        unlockEndingIds: ['ending_true_truth'],
        rewards: [
          { type: 'exp', value: 2000 },
          { type: 'soulOrbs', value: 20 },
          { type: 'attack', value: 10 },
...
export const ENDINGS: Ending[] = [
  {
    ...
    name: '希望之光',
    subtitle: '英雄结局',
    description: '你成为了传说中的英雄，为世界带来了和平与希望。',
    type: 'good',
    icon: '👑',
    color: '#22c55e',
    bgColor: '#dcfce7',
    storylineId: 'main_story_1',
    requiredLevel: 10,
    rewards: [
      { type: 'exp', value: 500 },
      { type: 'gold', value: 1000 },
    ...
    epilogueText: '在你的努力下，世界恢复了和平。人们传颂着你的名字，将你视为救世主。但你知道，这只是命运轮回中的一个小小篇章...',
    order: 1,
  },
  {
    id: 'ending_neutral_calm',
    name: '平静生活',
    subtitle: '普通结局',
    description: '你选择了一条平凡的道路，过上了简单而幸福的生活。',
    type: 'neutral',
    icon: '🏡',
    color: '#9ca3af',
    bgColor: '#f3f4f6',
    ...
    epilogueText: '你远离了纷争，在一个小村庄里过上了平静的生活。虽然没有惊天动地的成就，但这份平凡的幸福，或许才是最珍贵的...',
    order: 2,
  },
  {
    id: 'ending_bad_darklord',
    name: '堕入黑暗',
    subtitle: '黑暗结局',
    description: '你被黑暗力量吞噬，成为了新一代的黑暗领主。',
    type: 'bad',
    icon: '💀',
    color: '#ef4444',
    bgColor: '#fee2e2',
    ...
    epilogueText: '黑暗笼罩了大地，你成为了新的黑暗领主。但在内心深处，似乎还有什么东西在呼唤着你...也许下一次轮回，会有所不同。',
    order: 3,
  },
  {
    id: 'ending_companion_archer',
    name: '永恒的羁绊',
    subtitle: '伙伴结局',
    description: '与精灵弓手艾莉娅结下了永恒的羁绊。',
    type: 'good',
    icon: '💝',
    color: '#ec4899',
    bgColor: '#fce7f3',
    storylineId: 'companion_story_archer',
    requiredCompanions: ['forest_archer'],
    requiredLevel: 15,
    rewards: [
      { type: 'exp', value: 500 },
      { type: 'soulOrbs', value: 3 },
    ...
    inheritBonuses: [
      {
        id: 'archer_bond',
        name: '弓手羁绊',
        description: '开局即可招募森林弓手',
        icon: '🏹',
        type: 'companion',
        companionId: 'forest_archer',
      },
    ],
    epilogueText: '你和艾莉娅成为了最好的伙伴，一起经历了无数冒险。这份友谊，即使跨越轮回也不会消散...',
    order: 4,
  },
  {
    id: 'ending_true_truth',
    name: '世界的真相',
    subtitle: '真结局',
    description: '你揭开了世界最深层的秘密，知晓了轮回的真相。',
    type: 'true',
    icon: '👁️',
    color: '#fbbf24',
    bgColor: '#fef3c7',
    storylineId: 'secret_story_ancient',
    requiredLevel: 50,
    requiredTags: ['ancient_knowledge', 'guardian_blessed'],
    rewards: [
      { type: 'exp', value: 2000 },
    ...
    epilogueText: '原来，这个世界是一个巨大的试炼场。无数灵魂在这里轮回，只为寻找真正的自我。而你，终于觉醒了...下一次轮回，你将带着这份记忆，继续前行。',
    order: 5,
    hidden: true,
  },
  {
    id: 'ending_secret_collector',
    name: '收集大师',
    subtitle: '隐藏结局',
    description: '你收集了所有的伙伴和遗物，成为了传说中的收集大师。',
    type: 'secret',
    icon: '📚',
    color: '#8b5cf6',
    bgColor: '#ede9fe',
    ...
    epilogueText: '你的收藏室里摆满了稀有的宝物和珍贵的伙伴。在这个世界上，你已经收集了几乎所有值得收藏的东西...但还有什么在等待着你去发现呢？',
    order: 6,
    hidden: true,
  },
];

export const INHERITED_BONUSES: InheritedBonus[] = [
  {
    id: 'hero_blessing',
    name: '英雄祝福',
    description: '初始攻击力+3',
    ...
    stat: 'attack',
    value: 3,
    requiredEndingId: 'ending_good_hero',
  },
  {
    id: 'peaceful_mind',
    name: '平和之心',
    ...
    stat: 'maxHp',
    value: 20,
    requiredEndingId: 'ending_neutral_calm',
  },
  {
    id: 'dark_power',
    name: '黑暗力量',
    ...
    stat: 'attack',
    value: 5,
    requiredEndingId: 'ending_bad_darklord',
  },
  {
    id: 'archer_bond',
    name: '弓手羁绊',
    ...
    type: 'companion',
    companionId: 'forest_archer',
    requiredEndingId: 'ending_companion_archer',
  },
  {
    id: 'truth_awareness',
    name: '真理之眼',
    ...
    stat: 'attack',
    value: 5,
    requiredEndingId: 'ending_true_truth',
  },
  {
    id: 'soul_mastery',
    name: '灵魂精通',
  ...
  },
  {
    ...
    stat: 'luck',
    value: 5,
    requiredEndingId: 'ending_secret_collector',
  },
  {
